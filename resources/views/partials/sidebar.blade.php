<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="{{ Request::is('dashboard') ? 'active' : '' }}"><a class="nav-link" href="{{ asset(route('dashboard', [], false)) }}" ><i class="fas fa-fire"></i><span>Dashboard</span></a></li>
        ...
        <li class="menu-header">Riset</li>
        <li class="{{ Request::is('riset') ? 'active' : '' }}"><a class="nav-link" href="{{ asset(route('riset.index', [], false)) }}"><i class="fas fa-th"></i> <span>Kelola Riset</span></a></li>
        <li class="{{ Request::is('riset/create') ? 'active' : '' }}"><a class="nav-link" href="{{ asset(route('riset.create', [], false)) }}"><i class="far fa-file-alt"></i> <span>Tambah Riset</span></a></li>
        {{-- <li class="nav-item dropdown">
        ...
        <li class="{{ Request::is('user/create') ? 'active' : '' }}"><a class="nav-link" href="{{ asset(route('user.create', [], false)) }}"><i class="far fa-user"></i> <span>Tambah Pengguna</span></a></li>
        @endif
        {{-- <li class="nav-item dropdown">
